...
<head>
  ...
  if (isset($_POST['jalan2'])) {
    ...
    mysqli_query($conn, "UPDATE pasien SET alamat='$alamat', tgl_lahir='$tgl', berat_badan='$berat', tinggi_badan='$tinggi', j_kel='$jkel', no_tlp='$notlp', namakk='$kk', hubkel='$kel' WHERE nama_pasien='$namamu'");
  }
    ...
    if (count($_FILES['upload']['name']) > 0) {
      for ($i = 0; $i < count($_FILES['upload']['name']); $i++) {
        ...
        if ($tmpFilePath != "") {
          ...
          if (move_uploaded_file($filePath, $tmpFilePath)) {
    ...
    echo '<script>
				setTimeout(function() {
					swal({
						...
						text: "Foto Telah Berhasil Diupload",
						icon: "success"
						});
					}, 500);
			</script>';
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Masukan Data Sesuai Pasien</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mt-4">
                      ...
                      <div class="wizard-pane">
                        ...
                        if (isset($_POST['jalan1'])) { ?>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="text" class="form-control" name="j_kel" placeholder="">
                              <div class="invalid-feedback">
                                Mohon data diisi!
                              </div>
                            </div>
                          ...
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">No Telepon</label>
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="text" class="form-control" name="no_tlp" placeholder="">
                              <div class="invalid-feedback">
                                Mohon data diisi!
                              </div>
                            </div>
                          ...
                          <div class="form-group row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="text" class="form-control" name="namakk" placeholder="">
                              <div class="invalid-feedback">
                                Mohon data diisi!
                              </div>
                            </div>
                          ...
                          <div class="form-group row align-items-center">
                            <label class="col-md-4 text-md-right text-left">Hubungan Keluarga</label>
                            <div class="col-lg-4 col-md-6">
                              <input id="myInput" type="text" class="form-control" name="hubkel" placeholder="">
                              <div class="invalid-feedback">
                                Mohon data diisi!
                              </div>
                            </div>
                        ...
                        if (isset($_POST['jalan2'])) { ?>
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                              ...
                              <div class="col-sm-12 col-md-7">
                                <textarea placeholder="Wajib" class="summernote" name="diagnosa"></textarea>
                              </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="row">
                              <div class="col-12 col-sm-12 col-md-4">
                                <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                  ...
                                  <!-- <li class="nav-item">
                                    <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#profile4" role="tab" aria-controls="profile" aria-selected="false">Data Laboratorium </a>
                                  </li> -->
                                  <li class="nav-item">
                              ...
                              <div class="col-12 col-sm-12 col-md-8">
                                <div class="tab-content no-padding" id="myTab2Content">
                                  ...
                                  <div class="tab-pane fade" id="profile4" role="tabpanel" aria-labelledby="profile-tab4">
                                    <div class="card-body">
                                      <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Hasil Laboratorium  </label>
                                        <div class="col-sm-12 col-md-7">
                                          <input type="hidden" class="form-control" name="id" required="" value="<?php echo $idpasien; ?>">
                                          <input type="hidden" class="form-control" name="penyakit" required="" value="<?php echo $penyakit; ?>">
