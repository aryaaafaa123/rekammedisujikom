...
<head>
  ...
  if (isset($_POST['submit'])) {
    ...
    $up2 = mysqli_query($conn, "UPDATE pasien SET nama_pasien='$nama', tgl_lahir='$tgl', berat_badan='$berat', tinggi_badan='$tinggi', j_kel='$j_kel', no_tlp='$no_tlp', alamat='$alamat', namakk='$kk', hubkel='$kel' WHERE id='$id'");
    echo '<script>
				setTimeout(function() {
					swal({
					title: "Data Diubah",
...
<body>
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td align="center">
                                <form method="POST" action="detail_pasien.php">
                                  <span data-target="#editPasien" data-toggle="modal" data-id="<?php echo $idpasien; ?>" data-nama="<?php echo $row['nama_pasien']; ?>" data-lahir="<?php echo $row['tgl_lahir']; ?>" data-tinggi="<?php echo $row['tinggi_badan']; ?>" data-berat="<?php echo $row['berat_badan']; ?>" data-jkel="<?php echo $row['j_kel']; ?>" data-notlp="<?php echo $row['no_tlp']; ?>" data-alamat="<?php echo $row['alamat']; ?>" data-kk="<?php echo $row['namakk']; ?>" data-kel="<?php echo $row['hubkel']; ?>">
              ...
              <form action="" method="POST" class="needs-validation" novalidate="">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group col-sm-9">
                    <input type="date" class="form-control " id="getTgl" name="tgl">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="jkel" required="" id="getJKel">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <!-- <input type="hidden" class="form-control" name="no_tlp" required="" id="getNo_tlp"> -->
                    <input type="text" class="form-control" name="notlp" required="" id="getNoTlp">
                    <div class="invalid-feedback">
                      Mohon data diisi!
                    </div>
                  </div>
                ...
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Nama Kerabat</label>
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="kk" required="" id="getKk">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="kel" required="" id="getKel">
  ...
  <script>
    $('#editPasien').on('show.bs.modal', function(event) {
      ...
      var notlp = button.data('notlp')
      var alamat = button.data('alamat')
      var kk = button.data('kk')
      var kel = button.data('kel')
      var modal = $(this)
      ...
      modal.find('#getJKel').val(jkel)
      modal.find('#getNoTlp').val(notlp)
      modal.find('#getAlamat').val(alamat)
      modal.find('#getKk').val(kk)
      modal.find('#getKel').val(kel)
    })
  </script>
</body>
