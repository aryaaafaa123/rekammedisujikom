...
<head>
  ...
  if (isset($_POST['submit'])) {
    ...
    $stok = $_POST['stok'];
    $harga = $_POST['harga'];
    $keterangan = $_POST['ktobat'];

    $up2 = mysqli_query($conn, "UPDATE obat SET nama_obat='$nama', stok='$stok', harga='$harga', kt_obat='$keterangan' WHERE id='$id'");
    echo '<script>
				setTimeout(function() {
					swal({
					title: "Data Diubah",
  ...
  if (isset($_POST['submit2'])) {
    ...
    $add = mysqli_query($conn, "INSERT INTO obat (nama_obat, stok, harga, kt_obat) VALUES ('$nama', '$stok', '$harga', '$keterangan')");
    echo '<script>
				setTimeout(function() {
					swal({
						title: "Berhasil!",
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?php echo ($row['kt_obat']) ?></td>
                              <td align="center">
                                <span data-target="#editObat" data-toggle="modal" data-id="<?php echo $row['id']; ?>" data-nama="<?php echo $row['nama_obat']; ?>" data-harga="<?php echo $row['harga']; ?>" data-stok="<?php echo $row['stok']; ?>" data-ktobat="<?php echo $row['kt_obat']; ?>">
            ...
            <div class="modal-body">
              <form action="" method="POST" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group col-sm-9">
                    <input type="text" class="form-control" name="ktobat" required="" id="getKtobat" >
                    <div class="invalid-feedback">
                      Mohon data diisi!
                    </div>
                  </div>
