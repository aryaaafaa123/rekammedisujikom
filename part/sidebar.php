...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="menu-header">Menu  rekam medis</li>

      <li <?php echo ($page == "Rawat Jalan") ? "class=active" : ""; ?>><a class="nav-link" href="rawat_jalan.php"><i class="fas fa-stethoscope"></i> <span>Pemeriksaan Pasien</span></a></li>
      <li <?php echo ($page == "Data Pasien" || @$page1 == "det") ? "class=active" : ""; ?>><a class="nav-link" href="pasien.php"><i class="fas fa-user-injured"></i> <span>Data Medis</span></a></li>
      <li class="dropdown <?php echo ($page1 == "ruang" || $page1 == "riwayatinap") ? "active" : ""; ?>">
        ...
        <ul class="dropdown-menu">
          <li <?php echo (@$page1 == "ruang") ? "class=active" : ""; ?>><a class="nav-link" href="ruangan.php">Informasi Ruangan</a></li>
          <li <?php echo (@$page1 == "riwayatinap") ? "class=active" : ""; ?>><a class="nav-link" href="riwayat_inap.php">Riwayat Rawat Inap</a></li>
        </ul>
      </li>
      <li <?php echo ($page == "Laboratorium") ? "class=active" : ""; ?>><a class="nav-link" href="labo.php"><i class="fas fa-skull"></i> <span>Laboratorium</span></a></li>
      ...
      <li <?php echo ($page == "Kunjungan") ? "class=active" : ""; ?>><a class="nav-link" href="rm_knj.php"><i class="fas fa-users"></i> <span>Kunjungan</span></a></li>
      <li <?php echo ($page == "Dokter") ? "class=active" : ""; ?>><a class="nav-link" href="rm_dktr.php"><i class="fas fa-user"></i> <span>Dokter</span></a></li>
