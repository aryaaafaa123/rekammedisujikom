                ...
                <div class="card-body">
                  ...
                  <div class="col-lg-12">
                    <div class="card card-large-icons">
                      ...
                      <div class="card-body">
                        <h4>Kunjungan</h4>
                        <a href="rm_knj.php" class="card-cta">Detail <i class="fas fa-chevron-right"></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="card card-large-icons">
                      ...
                      <div class="card-body">
                        <h4>Dokter</h4>
                        <a href="rm_dktr.php" class="card-cta">Detail <i class="fas fa-chevron-right"></i></a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <div class="card card-large-icons">
                      ...
                      <div class="card-body">
                        <h4>Laboratorium</h4>
                        <a href="labo.php" class="card-cta">Detail <i class="fas fa-chevron-right"></i></a>
                      </div>
                    </div>
                  </div>
