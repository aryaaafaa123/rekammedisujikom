									...
									<div class="card-body">
										...
										<td>
											<?php if ($row['status'] == '1') { ?>
												...
												<a data-toggle="tooltip" title="Konfirmasi pasien keluar" class="btn btn-warning btn-action mr-1" data-confirm="Pasien Keluar|Apakah benar pasien yang bernama <b><?php echo ucwords($namapasien["nama_pasien"]) ?></b> akan keluar?" data-confirm-yes="window.open('updateriwayat.php?id=<?php echo $defpasien; ?>', '_blank'); location.reload();"><i class="ion-log-out"></i></a>
											<?php } else { ?>
